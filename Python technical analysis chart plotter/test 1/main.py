...
def get_price_hist(ticker):
    ...
    url = "https://query1.finance.yahoo.com/v7/finance/download/{ticker}?period1={10-10-2018}&period2={13-10-2018}&interval=1d&events=history".format(ticker=ticker, fro=fro, to=to)
...
nflx_df = get_price_hist("ETH-USD")
nflx_df2 = get_indicators(nflx_df)
plot_chart(nflx_df2, 365 , "ETH-USD")
